...
class OnlineConsultation(models.Model):
    appointment = models.ForeignKey(Appointment, on_delete=models.CASCADE, related_name='online_consultations')
    ...
    def __str__(self):
        return f"Online Consultation for Appointment #{self.appointment.appointmentnumber}"
